...
public class FastTerms
{
  
  private String url ;
  private ArrayList<TermPos> termPosList ; 
  private int size ; 
...
*/
  ...
  public FastTerms(ArrayList<TermPos> aTermPosList)
  {
	  termPosList = aTermPosList ; 
	  size = termPosList.size();
  }
  ...
  */
  public FastTerms( ArrayList<TermPos> aTermPosList , HashSet<String> selectedTerms)
  {
    termPosList = new ArrayList<TermPos>(); 
    size = aTermPosList.size();
    // Elimination von Termen 
    for (ListIterator<TermPos> iter = aTermPosList.listIterator(); iter.hasNext() ; ) 
    {
      TermPos tp = iter.next();
  ...
  public ArrayList<TermPos> getTermPosList()
  {
    return termPosList ; 
  }
  ...
  */
  public ArrayList<Feature> computeSimpleFeatureVector()
  {
    Map<String, Feature> featureMap = new HashMap<String, Feature>();
    ArrayList<Feature> result = new ArrayList<Feature>(); 
    
    for (ListIterator<TermPos> iter = termPosList.listIterator(); iter.hasNext(); )
    {
      TermPos tp = iter.next(); 
      String term = tp.getTerm(); 
      ...
      {
        Feature sel = featureMap.get(term);
        sel.weight = sel.weight + 1 ; 
      }
    }
    result.addAll( featureMap.values() );
    for (ListIterator<Feature> iter = result.listIterator(); iter.hasNext();)
    {
      Feature f = iter.next(); 
  ...
  */
  ...
  public ArrayList<Feature> computeReducedFeatureVector( HashSet<String> selectedTermSet)
  {
    Map<String, Feature> featureMap = new HashMap<String, Feature>();
    ArrayList<Feature> result = new ArrayList<Feature>(); 
